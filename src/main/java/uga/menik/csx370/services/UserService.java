...
public class UserService {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    return new User(foundUserId, firstName, lastName);
                }
            }
        }
        return null;
    ...
    public List<String> getFollowedUserIds(String userId) throws SQLException {
        final String sql = "select followeeId from follows where followerId = ?";
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    String followedUserId = rs.getString("followeeId");
